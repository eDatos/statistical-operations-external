...
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" target/statistical-operations-external-*.war deploy@estadisticas.arte.internal:$TRANSFER_PATH/statistical-operations-external.war
