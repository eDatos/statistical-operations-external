package es.gobcan.istac.sie.aop.logging;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(es.gobcan.istac.sie.repository..*)" + " || within(es.gobcan.istac.sie.service..*)" + " || within(es.gobcan.istac.sie.web.rest..*)")
